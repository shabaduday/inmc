<?php
	...
	if(isset($_SESSION['acc_id'])){
		...
		$select_borrower = mysqli_query($conn, "SELECT b.acc_id, a.givenname, a.address, a.contact, b.borrower_prev_bal, b.borrower_penalty, a.email, a.pass, b.borrower_curr_loan 
